      ...
      <div class="card-body">
       ...
       <!--    <div class="timeline-block">
          ...
          <div class="timeline-block">
            ...
            <div class="timeline-content">
              <small class="text-light font-weight-bold">{{dateTime(details.details.PFC)}}</small>
              <h5 class="text-white mt-3 mb-0">Picked From Customer</h5>
            </div>
          </div>
          <div class="timeline-block">
            <span class="timeline-step badge-danger">
            ...
            <div class="timeline-content">
              <small class="text-light font-weight-bold">{{dateTime(details.details.DAO)}}</small>
          ...
          <div class="timeline-block">
            ...
            <div class="timeline-content">
              <small class="text-light font-weight-bold">{{dateTime(details.details.DAT)}}</small>
          ...
          <div class="timeline-block">
            ...
            <div class="timeline-content">
              <small class="text-light font-weight-bold">{{dateTime(details.details.DTC)}}</small>
